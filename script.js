...
marker2.bindPopup("<b>Hello world! I'm marker 2</b><br>I am a popup.").openPopup();

circle.bindPopup("I am an AWSOME circle.");
polygon.bindPopup("I am a four sided polygon.");
